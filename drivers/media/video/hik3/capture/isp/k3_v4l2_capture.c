				...
				struct v4l2_control *a)
{
	...
	{
		a->value = k3_isp_get_af_level();
		break;
	}
	case V4L2_CID_GET_AF_RANGE_MIN:
	{
		a->value = k3_isp_get_af_ramge_min();
		break;
	}
	case V4L2_CID_GET_AF_RANGE_MAX:
	{
		a->value = k3_isp_get_af_ramge_max();
		break;
	}
	default:
		{
				...
				struct v4l2_control *v4l2_param)
{
	...
	{
		print_info("V4L2_CID_SET_VCM_DEST_CODE");
		k3_isp_set_af_dest_code(v4l2_param->value);
		break;
	}
default:
		break;
