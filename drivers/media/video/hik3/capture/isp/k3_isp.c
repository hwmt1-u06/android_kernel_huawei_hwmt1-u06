...
extern int ispv1_set_vcm_dest_code(u32 dest_code);
extern u32 ispv1_get_af_code(void);
extern u32 ispv1_get_af_range_min(void);
extern u32 ispv1_get_af_range_max(void);
...
int k3_isp_set_af_dest_code(u32 dest_code)
{
	int ret = -1;
...
int k3_isp_get_af_ramge_min(void)
{
     int ret = 0;
...
int k3_isp_get_af_ramge_max(void)
{
     int ret = 0;
     if (isp_data.sensor->af_enable)
