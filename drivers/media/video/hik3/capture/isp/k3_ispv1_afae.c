...
u32 ispv1_get_af_code(void)
{
	...
	print_info("%s, vcm->curr.code=%d", __func__, af_code);
	if(0 == af_code){
...
u32 ispv1_get_af_range_min(void)
{
	...
	print_info("%s, vcm->infiniteDistance=%d", __func__, vcm->infiniteDistance);
	if(0 == af_min){
		af_min =  VCM_MIN_CODE;
...
u32 ispv1_get_af_range_max(void)
{
	...
	print_info("%s, vcm->normalDistanceEnd=%d", __func__, vcm->normalDistanceEnd);
	if(0 == af_max){
		af_max =  VCM_MAX_CODE;
