...
static int tb_freqs[9][3]={
    {1508000,1508000,1500000},
    {1500000,1508000,1400000},
    {1400000,1500000,1399000},
    {1399000,1400000,1200000},
    {1200000,1399000,1000000},
...
static int tb_freqs_power[9][3]={
    {1508000,1508000,1500000},
    {1500000,1508000,1400000},
    {1400000,1508000,1399000},
    {1399000,1500000,1200000},
    {1200000,1400000,1000000},
    {1000000,1399000, 800000},
				   ...
				   const char *buf, size_t count)
{
	...
	dbs_tuners_ins.sampling_rate = input > MIN_SAMPLING_RATE ? input : MIN_SAMPLING_RATE;
	return count;
}
