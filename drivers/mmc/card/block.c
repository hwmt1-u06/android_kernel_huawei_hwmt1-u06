...
static int __init mmc_blk_init(void)
{
	...
	if(dentry_mmclog )
	{
		debugfs_create_file("rwlog_enable", S_IFREG|S_IRUSR|S_IWUSR|S_IRGRP|S_IWGRP,
		dentry_mmclog, NULL, &rwlog_enable_fops);
		debugfs_create_file("rwlog_index", S_IFREG|S_IRUSR|S_IWUSR|S_IRGRP|S_IWGRP,
		dentry_mmclog, NULL, &rwlog_index_fops);
		debugfs_create_file("debug_mask", S_IFREG|S_IRUSR|S_IWUSR|S_IRGRP|S_IWGRP,
