...
#else
#define HISI_MEM_CODEC_SIZE	(73 * SZ_1M)
#endif
#define HISI_MEM_VPP_SIZE	(5 * SZ_1M)
#if defined CONFIG_PMEM_ALTERNATIVES && CONFIG_PMEM_GRALLOC_SIZE != 0
#define HISI_PMEM_GRALLOC_SIZE (CONFIG_PMEM_GRALLOC_SIZE * SZ_1M+5*SZ_1M)
#else
#if defined(CONFIG_LCD_1080P)
#define HISI_PMEM_GRALLOC_SIZE  (126 * SZ_1M)
#else
#define HISI_PMEM_GRALLOC_SIZE	(155 * SZ_1M)
#endif
#endif
#define HISI_PMEM_DUMPLOG_SIZE	(2 * SZ_1M)

/* pmem for overlay */
#if defined CONFIG_PMEM_ALTERNATIVES && CONFIG_PMEM_OVERLAY_SIZE != 0
#define HISI_PMEM_OVERLAY_SIZE (CONFIG_PMEM_OVERLAY_SIZE * SZ_1M)
#else
